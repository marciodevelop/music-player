...
export const CardMusic = (props: IMusicPlayer.Track): React.ReactElement => {
  ...
  const currentTrack = useCurrentTrack((state: IMusicPlayer.CurrentTrackStore) => state.currentTrack);
  ...
  return (
    <div className="flex items-center justify-between w-[85.9%] min-h-[100px] shadow-[0px_25px_40px_0px_rgba(0,0,0,0.02)] rounded-3xl bg-light-white ml-[42px] dark:bg-dark-black-30 mt-[45px]">
      <div className="min-w-[84px] h-[84px] sticky ml-[-32px] my-[8px] rounded-[20px] bg-cover bg-no-repeat" style={{ backgroundImage: `url(${track.album.images[2].url})` }} />
      ...
      <div onClick={handlePlayPause} className="flex items-center justify-center w-[78px] h-[44px] rounded-[14px] mr-[48px] dark:bg-dark-black-40 bg-light-white shadow-[0px_15px_30px_0px_rgba(0,0,0,0.06)]">
